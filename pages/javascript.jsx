...
<Card bg={"white"} height={300}>
  ...
  <p color="black">{el.stargazers_count}</p>
  <p color="black">{el.owner.forks}</p>
...
export async function getStaticProps(){
  let response = await fetch(`https://api.github.com/search/repositories?q=stars:%3E1+language:javascript`)
